...
buyers  = [905423329882673164, 2, 3]              # Replace digits with Discord USER-IDs!
admins  = [905423329882673164, 2, 3]              # Replace digits with Discord USER-IDs! (admins!!)
owners  = [905423329882673164, 902596444148605018, 3]              # Replace digits with Discord USER-IDs! (owners, they cannot be removed!!)
token   = 'MTAwODE2MzQ3NjE2Nzk5MTM1Ng.G5XW4-.hAIAsFdhsIR65HyoGdRcV8eWSvQK6__ZYfe3y0'                  # Discord Bot token
